var gameManager = {
    ...
    loadAll: function(ctx) {
        ...
        spriteManager.loadAtlas("/resources/objects.json", "/resources/objects.png");
        this.factory['Player'] = Player;
        this.factory['Enemy'] = Enemy;
        this.factory['Shield'] = Shield;
        this.factory['Ammo'] = Ammo;
        this.factory['Shell'] = Shell;
    ...
    play: function(ctx) {
        gameManager.stop();
        gameManager.intervalId = setInterval(() => updateWorld(ctx), 20);
    },
    stop() {
